                ...
                <Tab.Navigator
                    screenOptions={({ route }) => ({
                        tabBarIcon: ({ focused, color, size }) => {
                            ...
                            if (route.name === "Home") {
                                iconName = focused ? require('./assets/home_click.png') : require('./assets/home_nonclick.png');
                            } else if (route.name === "Chatting") {
                                iconName = focused ? require('./assets/chatting_click.png') : require('./assets/chatting_nonclick.png');
                            } else if (route.name === "Calender") {
                                iconName = focused ? require('./assets/calendar_click.png') : require('./assets/calendar_nonclick.png');
                            } else if (route.name === "Feedback") {
                                iconName = focused ? require('./assets/feedback_click.png') : require('./assets/feedback_nonclick.png');
                            }

                            return <Image source={iconName} style={{ width: 25, height: 25 }} />;
                        },
                    })}
                    tabBarOptions={{ activeTintColor: '#4682B4', inactiveTintColor: 'gray' }}
                >
